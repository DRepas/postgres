		...
		typcache)
	{
		...
		switch (operator)
		{
			...
			case OID_RANGE_OVERLAPS_MULTIRANGE_OP:
				 ...
				 */
				selec = 1;
				selec -= calc_join_hist_lt_selectivity(rng_typcache, hist1_upper, nhist1, hist2_lower, nhist2);
				selec -= calc_join_hist_lt_selectivity(rng_typcache, hist2_upper, nhist2, hist1_lower, nhist1);
				break;
